...
class UserPreferencesRepositoryImpl @Inject constructor(
    ...
    override suspend fun updateTotalBalance(value: Double) = userPreferencesService.updateTotalBalance(value)

    override fun savingsPercentage(): Flow<Double> = userPreferencesService.savingsPercentage
    override suspend fun updateSavingsPercentage(value: Double) = userPreferencesService.updateSavingsPercentage(value)

    override fun currency(): Flow<Currency> = userPreferencesService.currency
    override suspend fun updateCurrency(currency: Currency) = userPreferencesService.updateCurrency(currency)

    override fun available(): Flow<Double> = userPreferencesService.available
    override suspend fun updateAvailable(value: Double) = userPreferencesService.updateAvailable(value)
